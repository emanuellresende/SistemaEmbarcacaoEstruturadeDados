...
#define MAXTravessa 4 // Como iniciamos a Pilha com 16 nao esta o Maximo travessa 5, mas sim 4
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <stdbool.h>
...
void atracando(fila *filanavios1, fila *filanavios2, fila *filanavios3, fila *filanavios4, Pilha *atraque1, Pilha *atraque2, Pilha *atraque3, Pilha *atraque4, int *num_atraque); // Realiza o Atrancamento
